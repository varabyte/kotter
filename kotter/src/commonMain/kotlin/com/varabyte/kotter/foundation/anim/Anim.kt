...
abstract class Anim protected constructor(
    ...
    companion object {
        ...
        val ONE_FRAME_60FPS: Duration = 16.milliseconds
         ...
         */
        private val ANIM_TIMER_DURATION: Duration = 8.milliseconds
    }

    /**
     * The total duration of this animation if all frames are played once.
     */
    val totalDuration: Duration get() = (frameMs * numFrames).milliseconds
    ...
    private val frameMs = frameDuration.inWholeMilliseconds.toInt()

    private fun elapse(duration: Duration) {
        elapsedMs += duration.inWholeMilliseconds.toInt()
