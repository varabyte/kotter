...
internal object LinkCommands {
     ...
     */
    // Note: Link commands support parameters using key/value pairs in a forward proof way, although currently it
    // doesn't seem like there are any really worth worrying about in practice. According to the docs, only "id" is
    // valid right now and I don't think Kotter applications need it. So for simplicity, we don't allow them to be set
    // for now.
