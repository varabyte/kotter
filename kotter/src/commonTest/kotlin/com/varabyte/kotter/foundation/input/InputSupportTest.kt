...
class InputSupportTest {
    ...
    // Kotter tests without flaking. Because tests can run at millisecond speeds, any tricky timing input issues that
    // occur due to section lifecycles getting started up / torn down can easily be triggered. Note that if you were a
    // regular human using a Kotter app, you'd never run into this issue, and worst case, maybe it would have dropped
    // your first keypress, if you somehow typed at subhuman speeds, at which point you'd probably just hit backspace
    // and type things in again.
